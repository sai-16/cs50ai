...
class CrosswordCreator():
    ...
    def revise(self, x, y):
        ...
        # change=False
        for k in self.domains[x]:
            f=0
            for l1 in self.domains[y]:
                if k==l1:
                    continue
                if k[i]==l1[j]:
                    f=1
    ...
    def assignment_complete(self, assignment):
        ...
        for i in set(self.domains.keys()):
    ...
    def consistent(self, assignment):
        ...
        for i in v:
            ...
            for j in v:
                if i!=j:
                    o=self.crossword.overlaps[i,j]
                    if not o:
                        continue
                    n1,n2=o
                    if assignment[i][n1]!=assignment[j][n2]:
                        return False
        if len(l)!=len(set(l)):
            return False
        return True
    ...
    def select_unassigned_variable(self, assignment):
        ...
        return values.
        """
        return (set(self.domains.keys())-set(assignment.keys())).pop()
